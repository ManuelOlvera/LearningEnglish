...
(function (root, factory) {
     ...
     * @constructor
     */
    forcetk.ClientUI = function (loginURL, consumerKey, callbackURL, proxy, successCallback, errorCallback) {
        ...
        if (typeof successCallback !== 'function') throw new TypeError('successCallback should be of type Function');
        this.successCallback = successCallback;

        if (typeof errorCallback !== 'undefined' && typeof errorCallback !== 'function')
            throw new TypeError('errorCallback should be of type Function');
            ...
            if (typeof window.device === 'undefined') { // Most likely app is running in a desktop browser
                ...
                var loginWindow = window.open(this._getAuthorizeUrl(),
                    'Login to Salesforce', 'height=' + winHeight + ',width=' + winWidth
                        ...
                        + ',left=' + centeredX + ',top=' + centeredY, true);
